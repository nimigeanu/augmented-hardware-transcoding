...
app.post('/publish', async (req, res) => {
  ...
  if (hardwareDevice !== null){
    const ffmpegCommand = `
      ...
      "
      -map "[a]"  -b:v 5M    -c:v mpsoc_vcu_h264 -f flv -y ${outputPath}_720p
      -map "[b]"  -b:v 2500K -c:v mpsoc_vcu_h264 -f flv -y ${outputPath}_480p
      -map "[c]"  -b:v 1750K -c:v mpsoc_vcu_h264 -f flv -y ${outputPath}_360p
